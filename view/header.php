    ...
    <nav>
        ...
        <ul class="nav_link_list">
            <li class="nav_link_item"><a class="nav_link_a" href="<?php echo $storagePath ?>">
                    ...
                    <span class="nav_link_a_span">Storage</span></a>
            </li>
            <div class="nav_link_item" id="regions_link_wrapper">
                <li class="nav_link_item"><a class="nav_link_a" id="regions_link" href="<?php echo $regionsPath ?>">
                        ...
                        <span class="nav_link_a_span">Regions</span></a>
                </li>
            ...
            <li class="nav_link_item"><a class="nav_link_a" href="<?php echo $citiesPath ?>">
                    ...
                    <span class="nav_link_a_span">Cities</span></a>
            </li>
            ...
            <li class="nav_link_item"><a class="nav_link_a" href="<?php echo $reportsPath ?>">
                    ...
                    <span class="nav_link_a_span">Reports</span></a>
            </li>
        </ul>
