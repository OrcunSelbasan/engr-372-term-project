<?php 
    ...
    function dirHandler() {
        $str = "";
        if (str_contains($_SERVER['REQUEST_URI'], 'reports/')) {
            $str = ".";
        } 
        echo $str;
    }
...
<header class="header <?php echo $className ?>">
    <nav>
        ...
        <ul class="nav_link_list">
            <li class="nav_link_item" ><a class="nav_link_a" href="<?php  dirHandler()?>./storage.php">
            ...
            <li class="nav_link_item"><a class="nav_link_a" href="<?php  dirHandler()?>./regions.php">
            ...
            <li class="nav_link_item"><a class="nav_link_a" href="<?php  dirHandler()?>./cities.php">
            ...
            <li class="nav_link_item"><a class="nav_link_a" href="<?php  dirHandler()?>./employees.php">
            ...
            <li class="nav_link_item"><a class="nav_link_a" href="<?php  dirHandler()?>./reports/storage_reports.php">
