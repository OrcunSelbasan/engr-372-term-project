...
$regionsPath = $rootPath . "/view/regions.php";
...
<header class="header <?php echo $className ?>">
    <nav>
        ...
        <ul class="nav_link_list">
            <li class="nav_link_item"><a class="nav_link_a" href="<?php echo $storagePath ?>">
            ...
            <li class="nav_link_item"><a class="nav_link_a" href="<?php echo $regionsPath ?>">
            ...
            <li class="nav_link_item"><a class="nav_link_a" href="<?php echo $citiesPath ?>">
            ...
            <li class="nav_link_item"><a class="nav_link_a" href="<?php echo $employeesPath ?>">
            ...
            <li class="nav_link_item"><a class="nav_link_a" href="<?php echo $reportsPath ?>">
