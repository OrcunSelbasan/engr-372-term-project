        ...
        <main class="storage-main">
            ...
            <section class="storage-table-wrapper">
                <table class="storage-table">
                    ...
                    <!-- TODO: sample row -->
                    <tr>
                        <td class="storage-table-data">123</td>
                        <td class="storage-table-data">Bin</td>
                        <td class="storage-table-data">50L</td>
                        <td class="storage-table-data">Regular</td>
                        <td class="storage-table-data">Active</td>
                        <td class="storage-table-data">19/11/2023</td>
                        <td class="storage-table-data">
                            <button class="storage-table-data-delete-btn">
                            ...
                            <a href="./storage-view-record.php?edit=true&id=123">
                            ...
                            <a href="./storage-view-record.php?id=123">
